...
{
	slider->setBounds(0, 0, proportionOfWidth(0.3338f), getHeight() - 20);
	comboBox->setBounds(proportionOfWidth(0.6662f), 0, proportionOfWidth(0.3338f), 24);
	slider2->setBounds(proportionOfWidth(0.3338f), 0, proportionOfWidth(0.3338f), getHeight() - 20);
